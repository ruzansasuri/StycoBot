Write-Host "Creating deployment package for Lambda B..."
...
# Create zip file
if (Test-Path deploy/StycoBot_B.zip) { Remove-Item deploy/StycoBot_B.zip -Force }
Compress-Archive -Path $deployDir\* -DestinationPath deploy/StycoBot_B.zip -Force

# Clean up deployment directory
Remove-Item -Path $deployDir -Recurse -Force

Write-Host "Deployment package created: deploy/StycoBot_B.zip"
